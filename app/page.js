  ...
  return (
    <RiddaLayout>
        ...
        <div className="container px-xxl-0    pt-180 rpt-90">
          <div className="row pt-50">
            <div className="col-xl-10">
              ...
              >
                <h1>
                  Creativity <br /> Meets <br /> Strategy
                </h1>
                <p>
                  At <strong>Hush Lush Technologies</strong>, we go beyond
                  design — we create <em>digital experiences</em> that reflect
                  your brand’s identity, engage your audience, and drive real
                  results. From stunning websites to powerful marketing
                  strategies, we ensure your business stands out in today’s
              ...
              <div className="about-content-four">
                <div className="section-title mb-40">
                  ...
                  <h2>
                    ...
                    Empowering Brands with <span>Hush Lush Technologies</span>
                  </h2>
                </div>
                <p>
                  ...
                  <strong>digital marketing and branding</strong>
                  to{" "}
                  <strong>
                    web & mobile app development, AR/VR, and enterprise
                    solutions
                  </strong>
                  , we help businesses in the GCC and India thrive in today’s
                  digital world.
                </p>
                <ul className="list-style-one my-30">
                  <li>Creative Branding & Graphic Design</li>
                  <li>Digital Marketing & SEO Optimization</li>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-7 col-lg-9 col-md-11">
              <div
                ...
                data-aos-offset={50}
              >
                <span className="subtitle mt-10 mb-15">How We Work</span>
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              ...
              >
                ...
                <div className="content">
                  ...
                  <p>
                    We start by analyzing your brand, market, and audience to
                    build a strategy tailored for success.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-sm-6">
              ...
              >
                <div className="content">
                  ...
                  <p>
                    Our team designs engaging visuals, branding assets, and
                    prototypes that reflect your unique identity.
                  </p>
                </div>
                <div className="circle" />
                <div className="image">
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              ...
              >
                ...
                <div className="content">
                  ...
                  <p>
                    We turn ideas into reality with seamless development,
                    marketing campaigns, and innovative technology.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-sm-6">
              ...
              >
                <div className="content">
                  ...
                  <p>
                    After launch, we provide ongoing support, analytics, and
      ...
      {/* <section className="project-area rel z-1">
        <div className="container  -x px-sm-0 py-130 rpy-100">
          <div className="row justify-content-center">
      ...
      <section className="testimonials-two-area bgc-lighter rel z-1">
        <div className="container px-0  -x pt-130 rpt-100 pb-170 rpb-140">
            ...
            <div className="row">
              <div className="col-lg-5">
                ...
                >
                  ...
                  <p>
                    At <strong>Hush Lush Technologies</strong>, we’ve helped
                    businesses across the GCC and India grow through{" "}
                    <em>
                      digital marketing, branding, web & mobile solutions, and
                      creative campaigns
                    </em>
