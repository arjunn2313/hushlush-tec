...
const FaqItem = () => {
  const faqData = [
    {
      question: "1. What services does Hush Lush Technologies provide?",
      answer:
        "We provide a full range of services including digital marketing, branding, graphic design, web development, mobile app development, AR/VR solutions, and enterprise software.",
      show: true,
    },
    {
      question: "2. How long does it take to build a website or mobile app?",
      answer:
        "Project timelines vary depending on complexity. A standard website may take 4–6 weeks, while custom mobile apps may take 8–12 weeks. We provide a detailed timeline after the consultation phase.",
    },
    {
      question: "3. Can you manage social media campaigns for my business?",
      answer:
        "Yes, we specialize in social media management across platforms like Facebook, Instagram, LinkedIn, and YouTube, with tailored content strategies to boost engagement and reach.",
    },
    {
      question: "4. Do you offer branding and graphic design services?",
      answer:
        "Absolutely! Our creative team designs logos, corporate identities, marketing materials, and ad campaigns that reflect your brand’s unique voice and vision.",
    },
    {
      question: "5. How do you ensure measurable results in digital marketing?",
      answer:
        "We use data-driven strategies, track KPIs such as conversions, engagement, and ROI, and provide detailed performance reports to ensure continuous growth for your brand.",
    },
  ];
      ...
      <div className="container   px-sm-0 pb-120 rpb-90">
        <div className="row justify-content-between">
          ...
          >
            ...
            <p>
              At <strong>Hush Lush Technologies</strong>, we aim to make every 
              project simple and transparent for our clients. Here are answers 
              to some of the most common questions about our 
              <em>digital marketing, branding, and technology services</em>.
            </p>
            <Link
              href="contact"
